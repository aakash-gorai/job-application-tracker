...
class AddRecordForm(forms.ModelForm):
	...
	application_date = forms.DateField(required=True, widget=forms.widgets.DateInput(attrs={"placeholder":"Application Date", 'type': 'text','onfocus': "(this.type='date')","class":"form-control"}), label="")
	...
	current_status = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Current Status", "class":"form-control"}), label="")
	class Meta:
		model = Record
		exclude = ("user",)